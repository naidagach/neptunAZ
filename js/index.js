...
function show(id, data, discounted = false) {
    ...
    if (elem) {
        ...
        data.map(item => {
            elem.innerHTML += `
                      <div  class="swiper-slide overflow-hidden rounded-[7px] bg-white py-2 flex justify-between items-center cursor-pointer">
                          <div class="relative w-full flex flex-col items-center  gap-[15px]">
                              <i onclick='addToWishlist(${JSON.stringify(item)})' class="fa-regular fa-heart cursor-pointer text-or absolute right-[20px] top-[15px]"></i>
                              ...
                              <div class="flex flex-col gap-[10px] items-center">
                                  <div class="flex items-center gap-[5px]">
                                      ...
                                      <div class="flex items-center">
                                          <p class="text-right px-2 text-[#3d3d3d] font-[700] outline-none">1</p>
